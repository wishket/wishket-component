...
(function (global, factory) {
  ...
  var DEFAULTS = {
    ...
    itemClass: 'wishket-calendar-object',
    ...
    hide: null,
    pick: null,
    onlyDefaultCalendar: true,
    // 다음달, 이전달 숫자 보여주나 안보여주나
    otherDay: false,
  };
  ...
  function getTheme(element){
    var theme;
    if(element.attr("class") && element.attr("class").match(/(theme-)\w+/g)){
      theme = element.attr("class").match(/(theme-)\w+/g)[0];
    }
    return theme = theme ? theme.split("theme-")[1] : '';
  }
  ...
  var handlers = {
    click: function click(e) {
      ...
      switch (view) {
        ...
        case 'month current':
          if (options.onlyDefaultCalendar) {
            break;
          }
          if (format.hasMonth) {
            this.showView(VIEWS.MONTHS);
  ...
  var render = {
    ...
    renderDays: function renderDays() {
      ...
      this.$picker.height((((picker__prevItems + length + picker__nextItems) / 7) * 34)+104);
  ...
  function () {
    function Datepicker(element) {
      ...
      this.startDate = null;
      this.endDate = null;
      this.theme = getTheme(this.$element);
      this.init();

      this.$element.wrap("<div class='icon-left ui-datepicker default-input-"+this.theme+"'></div>");
      this.$element.parent().append(this.$element.parent().siblings("i"));
    }
    ...
    _createClass(Datepicker, [{
      ...
      value: function build() {
        ...
        this.theme ? $picker.addClass(this.theme+'-calendar-object') : $picker.addClass(options.itemClass);
        if (this.inline) {
      ...
      value: function createItem(data) {
        ...
        if (item.picked && this.theme) {
          this.theme ? classes.push(this.theme+'-picked') : classes.push(options.pickedClass);
        }
